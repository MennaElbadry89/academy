...
export default function Options(){
 ...
 return (
    <section className="@container mx-auto">
        <label htmlFor="country" className="mt-5 block text-xl text-amber-500"> <b>Select your country</b></label>
        <div className="relative mx-auto mt-4 w-full">
            <input type="text" placeholder="select ur country" name="country"
                className="w-full rounded-lg border border-amber-700 p-2" value={search}
        ...
        {currentUser &&  selected && (<div className="mt-2 flex items-center gap-2 text-amber-500">
